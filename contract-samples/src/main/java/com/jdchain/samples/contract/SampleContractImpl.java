...
public class SampleContractImpl implements EventProcessingAware, SampleContract {
    ...
    @Override
    public void createRoleAndPermissions(String role, String ledgerPermissions, String txPermissions) {
